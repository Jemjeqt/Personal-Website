<template>
  <main
    ...
    <div class="space-y-2 text-center md:text-left px-10">
      ...
      <p class="text-white pr-4 fade-in-from-left">Welcome to My personal website portfolio.</p>
      <br>
...
export default {
  ...
  data() {
    return {
      toRotate: ["Web Developer", "Front - End Engineer", "Full - Stack Engineer", "Smart City Information System Student", "Tech Enthusiast"],
      period: 2000,
      txt: '',
      loopNum: 0,
      isDeleting: false,
